...
(* ================================================================== *)
(*                                                                    *)
(*            HANDLER-BOUNDARY NON-ESCAPE (impermeability)            *)
(*                                                                    *)
(* The dynamic guarantee completing the escape story: no value with a *)
(* local type ever crosses a handler boundary, in either direction,   *)
(* at any step of any execution.  A value observed crossing — the     *)
...
(*                                                                    *)
(* Together with capability confinement (Escape.v) this makes the     *)
(* boundary dynamically impermeable to local values: the only local   *)
(* thing that crosses it is the resumption itself, which is `local`   *)
(* by construction and cannot escape.                                 *)
(* ================================================================== *)
