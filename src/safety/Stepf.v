...
(*                                                                    *)
(* Completeness modulo marker renaming is NOT attempted here: the     *)
(* step relation is genuinely nondeterministic beyond marker choice   *)
(* (H_Perform's [pure_ectx_m] imposes no left-to-right value          *)
(* discipline on the captured context) — see the counterexample       *)
(* [step_not_deterministic_modulo_markers] in MarkerRename.v.         *)
(* ================================================================== *)
